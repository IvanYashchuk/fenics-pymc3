...
class FenicsVJPOp(Op):
    ...
    def perform(self, node, inputs, outputs):
        ...
        numpy_output, fenics_output, fenics_inputs, tape = evaluate_primal(self.ofunc, self.templates, *primal_inputs)
        # fenics_output, fenics_inputs, tape = self.fenics_output, self.fenics_inputs, self.tape
        numpy_grads = evaluate_vjp(g, fenics_output, fenics_inputs, tape)
